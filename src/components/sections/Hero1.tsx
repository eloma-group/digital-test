...
/* ════════════════════════════════════════════════════════════════════
   HERO 1 — Image hero with diagonal reveal (Fuji).
   The transparent→visible ramp runs on a diagonal (≈118°): invisible
   across the lower-left (text) area, fading in toward the top-right
   corner. Compositor-only ken-burns zoom.
   ════════════════════════════════════════════════════════════════════ */
export function Hero1() {
  const src = 'https://impeccable.style/neo-mirai/assets/manifesto-fuji-regenerated.webp'
  return (
    <>
      <style>{`
        ${SHARED_CSS}
        ...
        @media (max-width: 767px) {
          ...
          .hcImgD-fade { background: linear-gradient(118deg, ${CREAM} 0%, ${CREAM} 50%, rgba(255,255,255,0) 78%); }
        }
      `}</style>
